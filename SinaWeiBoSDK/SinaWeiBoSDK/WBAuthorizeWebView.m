...
- (id)init
{
    if (self = [super initWithFrame:CGRectMake(0, 0, 320, 480)])
    {
        ...
        closeButton = [[UIButton alloc] initWithFrame:CGRectMake(285, 25, 29, 30)];
        [closeButton setImage:[UIImage imageNamed:@"btn_deletebox.png"] forState:UIControlStateNormal];
        [closeButton setImage:[UIImage imageNamed:@"btn_deletebox_press.png"] forState:UIControlStateHighlighted];
